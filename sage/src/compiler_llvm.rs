...
//                             // }
//
//                             self.compilation_context.info[program.current_scope_index].push(ValueInfo::Function { info: function_call });
...
//                     // Using this value didn't make sense even before all the compiler changes.
//                     let scope = program.current_scope_index;
//
...
//                     self
//                         .compilation_context
//                         .variables[program.current_scope_index][index] = variable;
//                 }
//
//                 block::Op::GetLocal => {
//                     let index = frame.read_byte() as usize;
...
//                     let index = frame.read_byte() as usize;
//
//                     let variable_ref = self.compilation_context.variables[program.current_scope_index][index];
...
//
//                     let variable_ref = self.compilation_context.variables[program.current_scope_index - scope_distance][index];
//                     llvm::core::LLVMBuildStore(builder, value, variable_ref);
